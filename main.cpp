...
//void startgame(Plateau& plateau);
void testcase(Plateau &p);
...
int main() {
    ...
    Terrain t1("bleu fonce", "rue de la paix", plateau.getcase(0), 40000, loyer_t1, 20000);
    ...
    Gare g1 ("gare saint lazare", &c1, 20000, loyer_g1);
   ...
   int loyer_t8[6] = {2200,11000,33000,80000,97500,115000};
    ...
    Gare g3("gare de lyon", &t14, 20000, loyer_g3);
    ...
    Impot i2("impot sur le revenu", &g4,20000);
    ...
    Terrain t22("maron", "boulevard de belleville", &co3, 6000, loyer_t22, 5000);
...
//    appel du constructeur de jeu
    ...
    Jeu J(liste,0,plateau,nbr_player);
    J.schedule();
}

void testcase(Plateau &p) {
    p.getcase(0) -> arreterSur(NULL);
}
   ...
   int loyer_t8[6] = {2200,11000,33000,80000,97500,115000};
    ...
    dp.setSuivante(&t22);
        ...
        /*string n_p = "Cheval";
    Pion P(n_p, NULL , NULL);
    string prenom = "J"; 
    Case * liste_case[1];
    Depart dp(20000, NULL);
    liste_case[0] = &dp;
    liste_case[0] ->arreterSur(NULL);
